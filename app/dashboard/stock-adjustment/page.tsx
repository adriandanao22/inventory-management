  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="flex flex-col sm:flex-row p-3 sm:justify-between gap-3">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between flex-wrap gap-3 w-full">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              disabled={page <= 1}
              className="cursor-pointer p-2 rounded bg-white dark:bg-gray-800"
            >
              <FaArrowLeft />
            </button>
            ...
            <button
              ...
              className="cursor-pointer p-2 rounded border bg-white dark:bg-gray-800"
            >
              <FaArrowRight />
            </button>
